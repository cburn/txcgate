...
class TestMessage(unittest.TestCase):
    def test_ramp(self):
        ...
        msg = 'lighting ramp //HOME/254/56/46 50% 12m #sourceunit=6 OID=46ee8710-b6d5-1033-a7a8-bacdd30054cb'
        cmd = message.CGateVisitor().parse(msg)
        self.assertIsInstance(cmd, command.Ramp)
        self.assertEqual(cmd.address, '//HOME/254/56/46')
    ...
    def test_on(self):
        msg = 'lighting on //HOME/254/56/3  #sourceunit=6 OID=46e53840-b6d5-1033-a784-bacdd30054cb'
        cmd = message.CGateVisitor().parse(msg)
    ...
    def test_trigger(self):
        msg = 'trigger event //HOME/254/202/13 3 #sourceunit=6 OID=4706ca00-b6d5-1033-a7f1-bacdd30054cb'
        cmd = message.CGateVisitor().parse(msg)
    ...
    def test_security_armed(self):
        msg = '# security system_arm //HOME/254/208 1 #sourceunit=20 OID=473ef100-b6d5-1033-a89d-bacdd30054cb'
        cmd = message.CGateVisitor().parse(msg)
